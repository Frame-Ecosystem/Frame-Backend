...
import ReelController from '@controllers/content/reel.controller';
...
class ReelRoute implements Routes {
  ...
  private initializeRoutes() {
     ...
     * @access  Admin only
     */
    this.router.put('/:reelId/hide', authMiddleware, adminMiddleware, this.controller.hideReel);
     ...
     * @access  Admin only
     */
    this.router.put('/:reelId/unhide', authMiddleware, adminMiddleware, this.controller.unhideReel);
     ...
     * @access  Admin only
     */
    this.router.delete('/:reelId/admin', authMiddleware, adminMiddleware, this.controller.adminDeleteReel);
  }
}
