...
export const LIKE_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000; // 15 minutes
export const LIKE_RATE_LIMIT_MAX = 30;
export const FOLLOW_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000; // 15 minutes
export const FOLLOW_RATE_LIMIT_MAX = 30;
export const CONTENT_CREATE_RATE_LIMIT_WINDOW_MS = 60 * 60 * 1000; // 1 hour
export const CONTENT_CREATE_RATE_LIMIT_MAX = 20;
export const COMMENT_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000; // 15 minutes
export const COMMENT_RATE_LIMIT_MAX = 30;
export const REPORT_RATE_LIMIT_WINDOW_MS = 60 * 60 * 1000; // 1 hour
