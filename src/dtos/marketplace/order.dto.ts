import {
  IsString, IsOptional, IsEnum, IsNumber, IsArray, IsMongoId, MaxLength, Min, ValidateNested,
} from 'class-validator';
import { Type } from 'class-transformer';
import { PaymentMethod } from '@interfaces/marketplace/marketplace.interface';
