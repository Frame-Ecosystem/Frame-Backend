import { ServiceCategory } from '@systems/ServiceCatalogSystem/interfaces/serviceCategory.interface';
import { CreateServiceCategoryDto, UpdateServiceCategoryDto } from '@systems/ServiceCatalogSystem/dtos/serviceCategories.dto';
import serviceCategoryModel from '@systems/ServiceCatalogSystem/models/serviceCategory.model';
...
class ServiceCategoriesService {
  ...
  private async checkCategoryUsage(categoryId: string): Promise<number> {
    try {
      ...
      const serviceModel = (await import('@systems/ServiceCatalogSystem/models/service.model')).default;
