import { ServiceSuggestion, ServiceSuggestionStatus } from '@systems/ServiceCatalogSystem/interfaces/serviceSuggestion.interface';
import { LoungeServiceStatus } from '@systems/ServiceCatalogSystem/interfaces/loungeService.interface';
...
import serviceSuggestionModel from '@systems/ServiceCatalogSystem/models/serviceSuggestion.model';
...
class CatalogSuggestionsService {
  ...
  private async implementSuggestion(
    ...
    try {
      const ServicesService = (await import('@systems/ServiceCatalogSystem/services/services.service')).default;
      const LoungeServicesService = (await import('@systems/ServiceCatalogSystem/services/loungeServices.service')).default;
      const servicesService = new ServicesService();
      const loungeServicesService = new LoungeServicesService();

      const CategoryModel = (await import('@systems/ServiceCatalogSystem/models/serviceCategory.model')).default;
