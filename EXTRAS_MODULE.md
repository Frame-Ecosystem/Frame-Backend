...
### 2.3 Client — Read Only

| Method | Path | Auth | Description |
|--------|------|------|-------------|
| `GET` | `/v1/client/lounges/:loungeId/extras` | auth | List a lounge's active extras (any authenticated user) |
| `GET` | `/v1/extras` | auth | List all global extras (any authenticated user) |
